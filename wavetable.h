...
//const uint8_t  sinewave[] __attribute_ _ ((section (".MySection1")))= //sine 256 values
...
const uint8_t revsawtoothwave[] PROGMEM = //reverse sawtooth wave
//const uint8_t revsawtoothwave[] __attribute__ ((section (".MySection4")))= //reverse sawtooth wave
{
